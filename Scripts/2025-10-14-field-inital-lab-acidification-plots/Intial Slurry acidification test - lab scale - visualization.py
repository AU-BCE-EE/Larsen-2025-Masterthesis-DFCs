...
### catte 
plt.errorbar(xs1_cattle, pH_cattle_AA, yerr=pH_stdev_cattle_AA, fmt='o', color='#2b8cbe', label='Cattle AA', capsize=2)
plt.errorbar(xs1_cattle, pH_cattle_H2SO4, yerr=pH_stdev_cattle_H2SO4, fmt='o', color="#6e9fdf", label='Cattle H₂SO₄', capsize=2)
# Pig
plt.errorbar(xs1_pig, pH_pig_AA, yerr = pH_stdev_pig_AA, fmt='o',color="#EB0D0D", label='Pig AA', capsize=2)
