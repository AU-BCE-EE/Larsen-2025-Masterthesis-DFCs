...
datT <- data.frame(
  ...
  rain.cum = 0,
  app.rate.ni = 29,
  TAN.app = rep(c(63, 62.5, 62), each = n),
...
datHighDM <- data.frame(ctime = 160, TAN.app = 61, app.mthd = 'bc',
man.dm = 7.24 + 0.06, man.ph = 6.26, air.temp = 8.6, rain.cum = 0, app.rate.ni = 29)
#predHighDM <- alfam2(datHighDM, app.name = 'TAN.app', time.name = 'ctime', pars = pars_AUDFC)#
#print(predHighDM)

datLowDMAA <- data.frame(ctime = 160, TAN.app = 61, app.mthd = 'bc',
man.dm = 7.24 - 0.06, man.ph = 6.26, air.temp = 8.6, rain.cum = 0, app.rate.ni = 29)
#predLowDMAA <- alfam2(datLowDMAA, app.name = 'TAN.app', time.name = 'ctime', pars = pars_AUDFC)#
#print(predLowDMAA)

# same for H2SO4? DM and pH interaction? #
datHighDMH <- data.frame(ctime = 160, TAN.app = 62, app.mthd = 'bc',
man.dm = 7.24 + 0.06, man.ph = 6.25, air.temp = 8.6, rain.cum = 0, app.rate.ni = 29)
#predHighDMH <- alfam2(datHighDMH, app.name = 'TAN.app', time.name = 'ctime', pars = pars_AUDFC)#
#print(predHighDMH)

datLowDMH <- data.frame(ctime = 160, TAN.app = 62, app.mthd = 'bc',
man.dm = 7.24 - 0.06, man.ph = 6.25, air.temp = 8.6, rain.cum = 0, app.rate.ni = 29)
#predLowDMH <- alfam2(datLowDMH, app.name = 'TAN.app', time.name = 'ctime', pars = pars_AUDFC)#
#print(predLowDMH)
