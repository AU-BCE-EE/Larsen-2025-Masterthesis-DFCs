...
### Constants ### 
before_exp_dict = {('2026-04-14 00:00:0.00' , '2026-04-14 08:02:0.00' ): []}
...
6: 'LD', 7: 'HD_STD', 8: 'F', 9: 'HD', 10: 'LD', 12: 'BACKGROUND',
17: 'F', 18: 'LD', 19: 'F', 20: 'HD', 21: 'F', 27: 'BACKGROUND',
22: 'HD', 23: 'LD', 24: 'HD', 25: 'F', 26: 'LD', 28: 'BACKGROUND'}
# HD = High density
# LD = Low density
# F = field
# std = ammonium carbonate instead of cattle slurry

exp_start = '2026-04-14 08:02:0.00' # 2 hour delay in dat-file, switch to sommertime?
